...
enriched_RNA_in_glial_protrusions_hsap_sfari_df <- list(
  ...
  Enriched_RNA_in_glial_protrusions = enriched_RNA_in_glial_protrusions_hsap_conversion$hsapiens_homolog_ensembl_gene)
...
enhanced_translation_in_glial_protrusions_hsap_sfari_df <- list(
  SFARI = sfari_raw$ensembl_id, 
  Enhanced_translation_in_glial_protrusions = enhanced_translation_in_glial_protrusions_hsap_conversion$hsapiens_homolog_ensembl_gene)
