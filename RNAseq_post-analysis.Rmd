...
mouse_mart96 <- useMart("ENSEMBL_MART_ENSEMBL", dataset = "mmusculus_gene_ensembl", 
                        host = "https://apr2019.archive.ensembl.org")
mouse_biomart_attributes <- listAttributes(mouse_mart96)
mouse_GO_annotations <- getBM(attributes = c("ensembl_gene_id", "go_id", "name_1006", "definition_1006", "namespace_1003", "goslim_goa_accession", "goslim_goa_description"),
                                     mart = mouse_mart96,
                                     filters = "ensembl_gene_id",
                                     values = df_annotated$gene_id)
