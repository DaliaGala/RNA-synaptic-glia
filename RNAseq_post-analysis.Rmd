...
enriched_RNA_in_glial_protrusions_hsap_sfari_df <- list(
  SFARI = sfari_raw$ensembl_id, 
  `Enriched RNA in glial protrusions` = enriched_RNA_in_glial_protrusions_hsap_conversion$hsapiens_homolog_ensembl_gene)
...
enhanced_translation_in_glial_protrusions_hsap_sfari_df <- list(
  SFARI = sfari_raw$ensembl_id, 
  `Enhanced translation in glial protrusions` = enhanced_translation_in_glial_protrusions_hsap_conversion$hsapiens_homolog_ensembl_gene)
