...
```{r}
df_localised_FCA_supported <- df_localised_FCA %>%
...
write_tsv(count_df, "~/Desktop/Dmel_interesting-GO-categories_with-FCA-support1_sub_mimic.txt")
write_tsv(gene_name_df, "~/Desktop/Dmel_interesting-GO-categories_with-FCA-support2_sub_mimic.txt")

```

## How many genes have Mimic/Crimic/CPTI
